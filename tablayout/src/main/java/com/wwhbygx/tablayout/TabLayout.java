 ...
 * <p>
 * <pre>
 * &lt;com.wwhbygx.tablayout.widget.TabLayout
 *         android:layout_height=&quot;wrap_content&quot;
 *         android:layout_width=&quot;match_parent&quot;&gt;
 *
 *     &lt;com.wwhbygx.tablayout.widget.TabItem
 ...
 * </pre>
 *
 * @attr ref com.wwhbygx.tablayout.R.styleable#TabLayout_tabPadding
 * @attr ref com.wwhbygx.tablayout.R.styleable#TabLayout_tabPaddingStart
 * @attr ref com.wwhbygx.tablayout.R.styleable#TabLayout_tabPaddingTop
 * @attr ref com.wwhbygx.tablayout.R.styleable#TabLayout_tabPaddingEnd
 * @attr ref com.wwhbygx.tablayout.R.styleable#TabLayout_tabPaddingBottom
 * @attr ref com.wwhbygx.tablayout.R.styleable#TabLayout_tabContentStart
 * @attr ref com.wwhbygx.tablayout.R.styleable#TabLayout_tabBackground
 * @attr ref com.wwhbygx.tablayout.R.styleable#TabLayout_tabMinWidth
 * @attr ref com.wwhbygx.tablayout.R.styleable#TabLayout_tabMaxWidth
 * @attr ref com.wwhbygx.tablayout.R.styleable#TabLayout_tabTextAppearance
 * @attr ref com.wwhbygx.tablayout.R.styleable#TabLayout_tabIndicatorHeight
 * @attr ref com.wwhbygx.tablayout.R.styleable#TabLayout_tabIndicatorWidth
...
public class TabLayout extends HorizontalScrollView {
     ...
     * @attr ref com.wwhbygx.tablayout.R.styleable#TabLayout_tabIndicatorColor
     */
     ...
     * Sets the tab indicator's height for the currently selected tab.
     *
     * @param width width to use for the indicator in pixels
     * @attr ref com.wwhbygx.tablayout.R.styleable#TabLayout_tabIndicatorWidth
     */
    public void setSelectedTabIndicatorWidth(int width) {
        mTabStrip.setmSelectedIndicatorWidth(width);
    }
     ...
     * @attr ref com.wwhbygx.tablayout.R.styleable#TabLayout_tabMode
     */
     ...
     * @attr ref com.wwhbygx.tablayout.R.styleable#TabLayout_tabGravity
     */
     ...
     * Sets the text colors for the different states (normal, selected) used for the tabs.
     *
     * @attr ref com.wwhbygx.tablayout.R.styleable#TabLayout_tabTextColor
     * @attr ref com.wwhbygx.tablayout.R.styleable#TabLayout_tabSelectedTextColor
     */
    ...
    private int calculateScrollXForTab(int position, float positionOffset) {
        if (mMode == MODE_SCROLLABLE) {
            ...
            int scrollBase = (selectedChild != null ? selectedChild.getLeft() : 0) + (selectedWidth / 2) - (getWidth() / 2);
    ...
    private class SlidingTabStrip extends LinearLayout {
        ...
        public void draw(Canvas canvas) {
            ...
            if (mIndicatorLeft >= 0 && mIndicatorRight > mIndicatorLeft) {
                if (mSelectedIndicatorWidth <= 0) {//如果没有设置宽度，则保持原有逻辑
