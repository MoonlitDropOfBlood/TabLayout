 ...
 * to use it.
 *
 * @attr ref com.wwhbygx.tablayout.R.styleable#TabItem_android_icon
 * @attr ref com.wwhbygx.tablayout.R.styleable#TabItem_android_text
 * @attr ref com.wwhbygx.tablayout.R.styleable#TabItem_android_layout
 * @see TabLayout
 */
